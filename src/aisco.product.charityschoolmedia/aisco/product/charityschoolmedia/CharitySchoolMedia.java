package aisco.product.charityschoolmedia;
...
public class CharitySchoolMedia {
    ...
    public static List<Program> addProgram()
    {
        ...
        Program sponsoredSchool = ProgramFactory.createProgram("aisco.program.media.ProgramImpl", schoolconstruction, "Media Partner");
        ...
        programs.add(INDEX_SCHOOL, sponsoredSchool);
